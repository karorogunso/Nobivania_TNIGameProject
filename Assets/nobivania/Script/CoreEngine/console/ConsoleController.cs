...
public class ConsoleController {
	...
	void echo(string[] args) { //Echo text
	...
	void reload(string[] args) { //Reload cmd
        
        //Application.LoadLevel(Application.loadedLevel); // Unity < 5,4 version. Don't Remove this code.
    ...
    {
        //I think use GameObject. But I lazy for now.
    }
